...
public class Button {
	...
	public void render(Camera camera, TileSheet sheet, Shader shader) {
		...
		transform.identity().translate(position.x, position.y, 0).scale(scale.x/2, scale.y/2, 1); // Middle/Fill
	...
	private void renderSides(Vector2f position, Vector2f scale, Camera camera, TileSheet sheet, Shader shader) {
		transform.identity().translate(position.x, position.y + scale.y - 16, 0).scale(scale.x, 32, 1); // Top
		...
		transform.identity().translate(position.x, position.y - scale.y + 16, 0).scale(scale.x, 32, 1); // Bottom
		...
		transform.identity().translate(position.x - scale.x + 16, position.y, 0).scale(32, scale.y/2, 1); // Left
		...
		transform.identity().translate(position.x + scale.x - 16, position.y, 0).scale(32, scale.y/2, 1); // Right
	...
	private void renderCorners(Vector2f position, Vector2f scale, Camera camera, TileSheet sheet, Shader shader) {
		transform.identity().translate(position.x - scale.x + 16, position.y + scale.y - 16, 0).scale(32, 32, 1); // Top
														 // Left
		...
		transform.identity().translate(position.x - scale.x + 16, position.y - scale.y + 16, 0).scale(32, 32, 1); // Bottom
															// Left
